...
public class MaterialTestCase extends EntityTestCriteria {
    ...
    private Material createMaterial(Boolean isSave) throws SpartanPersistenceException, SpartanConstraintViolationException {
        ...
        brand.setBranddesc("URQpZjCOe6rr0kIpWOGpUpKsj7m9Mj0tZGuyr1dttisasje2ue");
        Category category = new Category();
        category.setCategory("d3kwiRfsY89qUVEdVmemlYwv7dltwuYRZqFjSJnGscHF7mO3GU");
        Category CategoryTest = new Category();
        if (isSave) {
            CategoryTest = categoryRepository.save(category);
            map.put("CategoryPrimaryKey", category._getPrimarykey());
        }
        brand.setBranddesc("vraUZjV9buhwvm9XUAVtNnK1qC63vVzuVU5t6CTcFn0BTuPbiX");
        ...
        material.setMaterialdesc("vO95m0yovJfB6rxBerOBAqewgOtXhXwUZb4ZeqUF4DZOTJda6S");
    ...
    public void test2Update() {
        try {
            ...
            material.setMaterialdesc("HSTiGbb8sEVvwTF8ZRQ8MAwI3cWeX65YYsjM5oSJjC2K31j6aH");
    ...
    private List<EntityTestCriteria> addingListOfFieldForNegativeTesting() {
        ...
        entityContraints.add(new EntityTestCriteria(MIN_MAX, 2, "materialdesc", "hTy71OvQkomyaUIqZXgi0cpLBeHXGiwTaDTs6LmdhbPS1f6Tv9XOhwad15EeROOvf"));
