...
public class DistributorTestCase extends EntityTestCriteria {
    ...
    private Distributor createDistributor(Boolean isSave) throws SpartanPersistenceException, SpartanConstraintViolationException {
        ...
        salesregion.setRegionname("VqefP1FE8ks9dG7OEbwO8P2S6ahQXUSlhXl3OWKeWOtiQlrjQQ");
        ...
        distributor.setLongitude(6640.0d);
        distributor.setDistributorname("MtwJwOOgOjQUhDBrMNe1o3wjme4eYo4ipE1wx4TttgjCpCdD1D");
        distributor.setLattitude(7000.0d);
    ...
    public void test2Update() {
        try {
            ...
            distributor.setDistributorname("5cEVJv1GoUMBgbsUgaB0l7XG3gUcJCQ2V5FvtaO7e1AqERvPMH");
            distributor.setLattitude(6700.0d);
    ...
    private List<EntityTestCriteria> addingListOfFieldForNegativeTesting() {
        ...
        entityContraints.add(new EntityTestCriteria(MIN_MAX, 2, "distributorname", "CJq16coaHOrE5sBpf1uB8E4GTZjB7yotAsZHeqP5f68txgoMNU2zPN7vN7NA9zoej"));
        entityContraints.add(new EntityTestCriteria(NOT_NULL, 3, "longitude", null));
        entityContraints.add(new EntityTestCriteria(MIN_MAX, 4, "longitude", 1.2145138881636217E19d));
        entityContraints.add(new EntityTestCriteria(NOT_NULL, 5, "lattitude", null));
        entityContraints.add(new EntityTestCriteria(MIN_MAX, 6, "lattitude", 1.6846007847336813E19d));
