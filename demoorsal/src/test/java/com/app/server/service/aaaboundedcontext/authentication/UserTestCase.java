...
public class UserTestCase extends EntityTestCriteria {
    ...
    private User createUser(Boolean isSave) throws SpartanPersistenceException, SpartanConstraintViolationException {
        ...
        useraccesslevel.setLevelIcon("A41E6F8rAgXfOXlykAtpcEzPu77aGQUkhQ7t41cJEBRY03amIm");
        useraccesslevel.setLevelDescription("3V6u8pO6Zle6YmBgcQq4IUTKZCL6iD9xMr9iqvQsA9bz0lIe17");
        useraccesslevel.setLevelName("434psZV7rIYHWnyu7LgTlCAMdrid0iJIzz8jHY5mzmrqrLJJVW");
        useraccesslevel.setLevelHelp("axcnTjxhK8AmGbJqrf75XF4tE7LdzNpcmPK6aA3S0izJQXwZYq");
        ...
        useraccessdomain.setDomainIcon("TnEFneoi76Zm5Bav87mICf4vBTBDrxo2Xs0LtChSLGfcOC6Fdf");
        useraccessdomain.setUserAccessDomain(valueGenerator.getRandomInteger(99999, 0));
        useraccessdomain.setDomainHelp("wfQzy3S5pyePDqBEJSXtMP72k0gQQpWichZvFt8MmQ8Tv5jDVK");
        useraccessdomain.setDomainName("og5uVBaiDengQSb3Ni6UrOm0I2AcV2LSmDtjIDjlRFWW1iX6Oz");
        useraccessdomain.setDomainDescription("GM52r4CG5v6Xkxyti67aNqABMcnvxE5ny7uC9h5z2WDyQ5YHTZ");
        ...
        user.setUserAccessCode(10715);
        user.setIsLocked(1);
        user.setUserAccessLevelId((java.lang.String) UserAccessLevelTest._getPrimarykey()); /* ******Adding refrenced table data */
        user.setMultiFactorAuthEnabled(1);
        user.setPasswordAlgo("uhNkYj3EMBzEKEBpoXiTSjk8fvFbuzXuBbsQeJQbbB5QOGcNOH");
        user.setUserAccessDomainId((java.lang.String) UserAccessDomainTest._getPrimarykey()); /* ******Adding refrenced table data */
        user.setGenTempOneTimePassword(1);
        user.setSessionTimeout(3579);
        user.setPasswordExpiryDate(new java.sql.Timestamp(1459587666673l));
        user.setLastPasswordChangeDate(new java.sql.Timestamp(1459587666673l));
        user.setChangePasswordNextLogin(1);
        java.util.List<PassRecovery> listOfPassRecovery = new java.util.ArrayList<PassRecovery>();
        PassRecovery passrecovery = new PassRecovery();
        Question question = new Question();
        question.setQuestionIcon("0U2Pk5QWzSfip33JsulumyaFMcnroO2UTFeB9olYZ7CH4PRCAJ");
        question.setLevelid(3);
        question.setQuestion("74fgj2PVQPudeMB6VQTEsHDYWLyjq9sGiaiThODTuROWvnuVmW");
        question.setQuestionDetails("5QYqcvGxgk");
        ...
        passrecovery.setAnswer("5uoiI0qY5GavXUgvOH6DZMt9kvfwkDLXAh37EDUSdopj5JNFgo");
        listOfPassRecovery.add(passrecovery);
        user.addAllPassRecovery(listOfPassRecovery);
        UserData userdata = new UserData();
        userdata.setUser(user);
        userdata.setOneTimePassword("mQbvojszubmnj3NMD8QMi49hHXSgcBAs");
        userdata.setOneTimePasswordGenDate(new java.sql.Timestamp(1459587667184l));
        userdata.setOneTimePasswordExpiry(6);
        userdata.setLast5Passwords("7wmt979wpaEgTZ3bQebMJH0mZeV5AALcDMxFyQz3hEGt8547Bz");
        userdata.setPassword("uaJJJps4e0bbSWiIi4fszQuFViibVofQr1xG6Pp7kWJmCqRabD");
    ...
    private List<EntityTestCriteria> addingListOfFieldForNegativeTesting() {
        ...
        entityContraints.add(new EntityTestCriteria(MIN_MAX, 1, "userAccessCode", 99262));
        ...
        entityContraints.add(new EntityTestCriteria(MIN_MAX, 8, "passwordAlgo", "HihYx1df0ecgxArNQnHdbOlgMOKmwcy3FviYMXBCSEEL2Ap7csnfH1YiL4ZOAUXTs"));
        entityContraints.add(new EntityTestCriteria(MIN_MAX, 9, "sessionTimeout", 4512));
