...
public class RetailerTestCase extends EntityTestCriteria {
    ...
    private Retailer createRetailer(Boolean isSave) throws SpartanPersistenceException, SpartanConstraintViolationException {
        ...
        distributor.setDistributorname("eAA1tDIjog2LdkfDfCnKWRu5WSEADMxtyLseDbFYCOzqtcbp9P");
        distributor.setLattitude(2300.0d);
        SalesRegion salesregion = new SalesRegion();
        salesregion.setRegionname("p1NHb7WolHSm0SM9DqUXO0LAA5EpqxuAJYZTOIEjfPIhLvPmOc");
        ...
        distributor.setLongitude(5152.0d);
        distributor.setDistributorname("7PmIaSjDE42n0occCz9SN2sKLv3u4np5hwd6wnJMebtIoAiM4h");
        distributor.setLattitude(2200.0d);
        ...
        retailer.setRetailername("vVtQVGcvFaB8nCVqYojAHPbxMIx9Oa19Tbx0JZXekWyvVqHQZG");
    ...
    public void test2Update() {
        try {
            ...
            retailer.setRetailername("p6lwCiRqflwuikghcLNnDlWtURLNoggiLHHoTwLFjWf6FnySte");
    ...
    private List<EntityTestCriteria> addingListOfFieldForNegativeTesting() {
        ...
        entityContraints.add(new EntityTestCriteria(MIN_MAX, 2, "retailername", ""));
