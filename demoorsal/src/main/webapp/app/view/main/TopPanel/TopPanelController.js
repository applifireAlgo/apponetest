Ext.define('Demoorsal.view.main.TopPanel.TopPanelController', {
	...
	onSearchClick : function(button) {
		...
		//	"Demoorsal.view.scheduler.scheduler"
		var component = Ext.create(
				"Demoorsal.view.searchengine.search.SearchEngineMainPanel", {
					closable : true,
					title : "Search Engine",
					refId : "-1"
				});
	...
	{
		var component = Ext.create(
				"Demoorsal.view.clouddrive.CloudDrive", {
					closable : true,
					title : "Cloud Drive",
					//refId : "-1"
				});
