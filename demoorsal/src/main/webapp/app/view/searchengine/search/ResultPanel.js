Ext
		.define(
				'Demoorsal.view.searchengine.search.ResultPanel',
				{
					extend : 'Ext.panel.Panel',
					xtype : 'resultPanel',
					itemId : "resultsTab",
					plugins : 'responsive',
					requires : [ 'Demoorsal.view.searchengine.search.SearchEngineMainPanelController','Demoorsal.view.searchengine.search.PanelHeaderField' ,'Demoorsal.view.searchengine.search.ReportGridView','Demoorsal.view.searchengine.search.ReportChartView','Demoorsal.view.searchengine.search.documentView','Demoorsal.view.searchengine.search.DouMeanView','Demoorsal.view.googlemaps.map.MapPanel'],
