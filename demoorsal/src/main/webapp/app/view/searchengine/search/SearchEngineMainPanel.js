Ext.define('Demoorsal.view.searchengine.search.SearchEngineMainPanel', {
	extend : 'Ext.panel.Panel',
	xtype : 'solrsearchmainpanel',
	

	requires : ['Demoorsal.view.searchengine.search.NorthPanel', 'Demoorsal.view.searchengine.search.SearchResult','Demoorsal.view.searchengine.search.SearchEngineMainPanelController'],
