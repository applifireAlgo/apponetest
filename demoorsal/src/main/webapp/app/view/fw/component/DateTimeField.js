 ...
 */
Ext.define('Demoorsal.view.fw.component.DateTimeField', {
    extend: 'Ext.form.field.Date',
    alias: 'widget.customdatetimefield',
    xtype : 'customdatetimefield',
    requires: ['Demoorsal.view.fw.component.DateTimePicker'
               ],
    ...
    createPicker: function() {
        ...
        return new Demoorsal.view.fw.component.DateTimePicker(o);
    },
