Ext.define('Demoorsal.view.usermanagement.admin.AdminUserManagement', {
	extend : 'Ext.tab.Panel',
	requires : ['Demoorsal.view.usermanagement.admin.UserPasswordReset',
	            'Demoorsal.view.usermanagement.admin.AddUserDetails',
	            'Demoorsal.view.usermanagement.admin.ViewUser'],
