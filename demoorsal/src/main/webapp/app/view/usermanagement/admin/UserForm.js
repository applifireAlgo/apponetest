Ext.define('Demoorsal.view.usermanagement.admin.UserForm', {
	extend : 'Ext.form.Panel',
	xtype : 'userForm',
	itemId : 'userForm',
	requires : [ 'Demoorsal.view.usermanagement.admin.AddUserDetailsViewModel', 'Demoorsal.model.AddUserDataModel' ],
