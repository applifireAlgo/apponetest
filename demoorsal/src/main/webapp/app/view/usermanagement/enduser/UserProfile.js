Ext.define('Demoorsal.view.usermanagement.enduser.UserProfile', {
	extend : 'Ext.form.Panel',
	xtype : 'userProfileView',
	requires : [ 'Demoorsal.view.usermanagement.enduser.UserProfileController', 'Demoorsal.view.usermanagement.admin.AddUserDetailsViewModel', 'Demoorsal.model.AddUserDataModel' ],
