 ...
 * 
 */
Ext.define('Demoorsal.view.securityconfig.SecurityConfig', {
	extend : 'Ext.form.Panel',
	xtype : 'securityConfig',
	requires : [ 'Demoorsal.view.securityconfig.SecurityConfigController',
			'Demoorsal.view.securityconfig.SecurityQuestion', 'Ext.form.FieldSet',
