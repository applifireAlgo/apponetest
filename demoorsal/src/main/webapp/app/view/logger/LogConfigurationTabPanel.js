...
Ext
		.define(
				'Demoorsal.view.logger.LogConfigurationTabPanel',
				{
					...
					requires : [
							'Demoorsal.view.logger.tabs.details.DetailsTab',
							'Demoorsal.view.logger.tabs.fileconnector.FileConnectorTab',
							'Demoorsal.view.logger.tabs.dbconnector.DBConnectorTab',
							'Demoorsal.view.logger.tabs.syslogsocketconnector.SyslogSocketConnectorTab',
							'Demoorsal.view.logger.tabs.tcpsocketconnector.TCPSocketConnectorTab',
							'Demoorsal.view.logger.LogConfigurationTabPanelController',
