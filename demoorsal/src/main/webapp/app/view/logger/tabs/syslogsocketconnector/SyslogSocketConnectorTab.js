 ...
 * 
 */
Ext.define('Demoorsal.view.logger.tabs.syslogsocketconnector.SyslogSocketConnectorTab', {
	...
	requires : ['Demoorsal.view.logger.tabs.syslogsocketconnector.SyslogSocketConnectorTabController'],
