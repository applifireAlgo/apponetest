 ...
 * 
 */
Ext.define('Demoorsal.view.logalarm.mainscreen.AddLogAlarm', {
	extend : 'Ext.form.Panel',
	xtype : 'addLogAlarm',
	requires : [ 'Demoorsal.view.logalarm.mainscreen.AddLogAlarmController',
			'Demoorsal.view.logalarm.mainscreen.AppAlarmGridPanel',
			'Demoorsal.view.logalarm.mainscreen.AppAlarmPanel',
