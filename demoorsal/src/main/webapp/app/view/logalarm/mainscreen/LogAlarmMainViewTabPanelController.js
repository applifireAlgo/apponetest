 ...
 * 
 */
Ext.define('Demoorsal.view.logalarm.mainscreen.LogAlarmMainViewTabPanelController', {
	...
	init : function()
	{
		...
		var component = Ext.create("Demoorsal.view.logalarm.mainscreen.AddLogAlarm", {
			title : "Log Module",
		});
