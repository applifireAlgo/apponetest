 ...
 * 
 */
Ext.define('Demoorsal.view.logalarm.LogAlarmMainView', {
	extend : 'Ext.form.Panel',
	xtype : 'logAlarmMainView',
	requires : [ 'Demoorsal.view.logalarm.LogAlarmMainViewController',
			'Demoorsal.view.logalarm.tree.LogAlarmTreePanel',
			'Demoorsal.view.logalarm.mainscreen.LogAlarmMainViewTabPanel',
