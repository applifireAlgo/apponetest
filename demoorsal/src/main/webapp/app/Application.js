 ...
 */
Ext.define('Demoorsal.Application', {
	...
	requires : [ "Ext.ux.BoxReorderer", "Ext.ux.CellDragDrop",
			...
			"Ext.ProgressBarWidget", "Ext.ZIndexManager","Demoorsal.view.databrowsercalendar.DBCalendar" ],
	...
	stores : [ 'Demoorsal.store.QueryCriteriaWidgetsStore' ],
	...
	try {
		...
		if (responseData.response) {
			if (responseData.response.exceptionId == 4005 && !sessionTimeOutFlag) {
				...
				var loginWindow = Ext.create('Demoorsal.view.login.SessionLogin').center();
