...
public class UserTestCase extends EntityTestCriteria {
    ...
    private User createUser(Boolean isSave) throws SpartanPersistenceException, SpartanConstraintViolationException {
        ...
        useraccesslevel.setLevelHelp("iKvoFx7SBjulfVWPCz6u1AKmOFqqPR3AY8bJvmFSYwOaHe55M9");
        useraccesslevel.setLevelIcon("wYwPNaRNSlKm4nREMQn250RgxPBFTKZ94FM1wpUldheCOl06XN");
        useraccesslevel.setLevelDescription("HILej1xcWqQ30vXQ8v17ZJBYIzn8I2MV5rjV5EYVWN9QtXK7gb");
        useraccesslevel.setUserAccessLevel(valueGenerator.getRandomInteger(99999, 0));
        useraccesslevel.setLevelName("eoSvfip32ng2mZO7XqVoRSUZwo1H1LLyHoYR6aJ5k6wKs1NA4D");
        ...
        useraccessdomain.setDomainName("M5QVTlnoSmjcQUVMdZTN6ZlP8WfPkGsyOjOvvqEqi9Q2aoqdYb");
        useraccessdomain.setDomainHelp("PPU9dTcOka61tuuuNxKbxeqyKHroYFpZShbvKQ4KBRJGNtAMkj");
        useraccessdomain.setDomainIcon("sIO6Kq9Ba9hEEvpCXkAgTJFu4WucqvmRtnYFYEpeK58XuZF0qo");
        useraccessdomain.setDomainDescription("6xDdNoMEzRdD1YZlPeKyHUz2vnthhdsz8N8D0AYhcM3hMD8Dpt");
        ...
        User user = new User();
        user.setIsLocked(1);
        user.setLastPasswordChangeDate(new java.sql.Timestamp(1459583586001l));
        user.setPasswordExpiryDate(new java.sql.Timestamp(1459583586002l));
        user.setChangePasswordNextLogin(1);
        user.setUserAccessLevelId((java.lang.String) UserAccessLevelTest._getPrimarykey()); /* ******Adding refrenced table data */
        user.setUserAccessDomainId((java.lang.String) UserAccessDomainTest._getPrimarykey()); /* ******Adding refrenced table data */
        user.setGenTempOneTimePassword(1);
        user.setPasswordAlgo("wl3pw9L97pCqhU04fRfqUgsAOicjYcsG5HYpKvjwcR9u1W2Rmq");
        user.setSessionTimeout(3554);
        user.setIsDeleted(1);
        user.setUserAccessCode(32166);
        user.setMultiFactorAuthEnabled(1);
        user.setAllowMultipleLogin(1);
        java.util.List<PassRecovery> listOfPassRecovery = new java.util.ArrayList<PassRecovery>();
        PassRecovery passrecovery = new PassRecovery();
        passrecovery.setAnswer("w29j0PkI4YjsgdYb9VPVfHGLD9OyReICc7c3vmAQPqy4qlZ57x");
        Question question = new Question();
        question.setQuestionIcon("dT0NZjKZ6lRS3F1VIhiQLZyEEIBa6drg5NfjrTC3OrMlkUO8rz");
        question.setLevelid(1);
        question.setQuestionDetails("hlypI1PmRt");
        question.setQuestion("0C6wym9vjt63WuKPZdi4hQgBn3r1UKXp41cuF3zFUbgWR11GNH");
        Question QuestionTest = new Question();
        if (isSave) {
            QuestionTest = questionRepository.save(question);
            map.put("QuestionPrimaryKey", question._getPrimarykey());
        }
        passrecovery.setAnswer("qAvIo4M4M7ftxPhqNMsS9YPoDCAXIQPsKf0XTIhhacukZrlbh7");
        passrecovery.setQuestionId((java.lang.String) QuestionTest._getPrimarykey());
        passrecovery.setUser(user);
        listOfPassRecovery.add(passrecovery);
        user.addAllPassRecovery(listOfPassRecovery);
        UserData userdata = new UserData();
        userdata.setOneTimePasswordGenDate(new java.sql.Timestamp(1459583586557l));
        userdata.setOneTimePasswordGenDate(new java.sql.Timestamp(1459583586582l));
        userdata.setUser(user);
        userdata.setPassword("7CqlLPlJOpOXjtmTxngNlfJp5dnoTO51KTth5gNYHLRXPwdykq");
        userdata.setOneTimePassword("kQnt8P0Dn7xJd9kKGQ1sudhFq2Y6ySvi");
        userdata.setOneTimePasswordExpiry(10);
        userdata.setLast5Passwords("wa7d4rcBKuV1uiQD0Y0NvaTIgZptFq00exN5W1egnUS1BXKjCC");
    ...
    private List<EntityTestCriteria> addingListOfFieldForNegativeTesting() {
        ...
        entityContraints.add(new EntityTestCriteria(MIN_MAX, 1, "userAccessCode", 63151));
        ...
        entityContraints.add(new EntityTestCriteria(MIN_MAX, 8, "passwordAlgo", "a1TKQYha3RnBxnwe6l18CvNuO5rCQF5pnEIrfuqOasOhBaI6oTircBWaJAJJAsgxh"));
        entityContraints.add(new EntityTestCriteria(MIN_MAX, 9, "sessionTimeout", 5687));
