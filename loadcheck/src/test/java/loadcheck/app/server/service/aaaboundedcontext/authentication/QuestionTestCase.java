...
public class QuestionTestCase extends EntityTestCriteria {
    ...
    private Question createQuestion(Boolean isSave) throws SpartanPersistenceException, SpartanConstraintViolationException {
        ...
        question.setQuestionIcon("72a0nd28UMcMaD4OnTOn8kYkWTQFZNNmBWNqQwTAtba0MiZzbM");
        question.setLevelid(3);
        question.setQuestionDetails("hWKeVt0GJA");
        question.setQuestion("G3jSkVrD3yahhWblFCIFpA5mtieFndIsFeIVqZZyesoiSj633d");
    ...
    public void test2Update() {
        try {
            ...
            question.setQuestionIcon("v180aWBbhnN5U2l7X56us7R34z7T1RWBJK0s1CxtaSDEyyVMYC");
            question.setLevelid(10);
            question.setQuestionDetails("s3rxXqAmbk");
            question.setQuestion("cb7K821952ZTEuu5zEsgRz4iSxHCp4JlBJSCOTpPRo1JHPyInP");
    ...
    private List<EntityTestCriteria> addingListOfFieldForNegativeTesting() {
        ...
        entityContraints.add(new EntityTestCriteria(MIN_MAX, 4, "question", ""));
        entityContraints.add(new EntityTestCriteria(MIN_MAX, 5, "questionDetails", ""));
        entityContraints.add(new EntityTestCriteria(MIN_MAX, 6, "questionIcon", "RUNJTZanWH9Z1BG7qqDrfE8EnL4ddDYHA6IHWu1BEIcCqAvhywoITg7yx17VGPI3y"));
