...
@RestController
@SourceCodeAuthorClass(createdBy = "deepali.arvnd@algorhythm.co.in", updatedBy = "", versionNumber = "1", comments = "Service for CommunicationType Master table Entity", complexity = Complexity.LOW)
...
public class CommunicationTypeServiceImpl extends CommunicationTypeService {
    ...
    public HttpEntity<ResponseBean> findAll() throws SpartanPersistenceException, Exception {
        ...
        java.util.List<loadcheck.app.shared.organizationboundedcontext.contacts.CommunicationType> lstcommunicationtype = communicationTyperepo.findAll();
    ...
    public HttpEntity<ResponseBean> findByCommGroupId(@RequestBody FindByBean findByBean) throws SpartanPersistenceException, Exception {
        ...
        org.springframework.http.HttpStatus httpStatus = org.springframework.http.HttpStatus.OK;
        try {
            List<loadcheck.app.shared.organizationboundedcontext.contacts.CommunicationType> lstcommunicationtype = communicationTyperepo.findByCommGroupId((java.lang.String) findByBean.getFindKey());
            responseBean.add("success", true);
            responseBean.add("message", "Successfully retrived ");
            responseBean.add("data", lstcommunicationtype);
        } catch (org.springframework.transaction.TransactionException e) {
    ...
    public HttpEntity<ResponseBean> findById(@RequestBody FindByBean findByBean) throws SpartanPersistenceException, Exception {
        ...
        org.springframework.http.HttpStatus httpStatus = org.springframework.http.HttpStatus.OK;
        try {
            loadcheck.app.shared.organizationboundedcontext.contacts.CommunicationType lstcommunicationtype = communicationTyperepo.findById((java.lang.String) findByBean.getFindKey());
            responseBean.add("success", true);
            responseBean.add("message", "Successfully retrived ");
            responseBean.add("data", lstcommunicationtype);
        } catch (org.springframework.transaction.TransactionException e) {
