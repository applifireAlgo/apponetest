package loadcheck.app.server.service.organizationboundedcontext.contacts.aspect;
import loadcheck.app.server.service.aspect.ServiceAspect;
...
public class ServicecontactsAspect extends ServiceAspect {
    ...
    @Pointcut("execution(* loadcheck.app.server.service.organizationboundedcontext.contacts..save*(..))")
    protected void saveOperation() {
    }

    @Pointcut("execution(* loadcheck.app.server.service.organizationboundedcontext.contacts..update*(..))")
    protected void updateOperation() {
    }

    @Pointcut("execution(* loadcheck.app.server.service.organizationboundedcontext.contacts..delete*(..))")
    protected void deleteOperation() {
    }

    @Pointcut("execution(* loadcheck.app.server.service.organizationboundedcontext.contacts..find*(..))")
    protected void findOperation() {
    }

    @Pointcut("execution(* loadcheck.app.server.service.organizationboundedcontext.contacts..get*(..)) && !within(com.spartan.shield.sessionService.SessionDataMgtService+)")
    protected void getOperation() {
    }

    @Pointcut("execution(* loadcheck.app.server.service.organizationboundedcontext.contacts..*(..)) && !within(com.spartan.shield.sessionService.SessionDataMgtService+)")
