...
import loadcheck.app.server.businessservice.aaaboundedcontext.authorization.RolesBusinessService;
...
@RestController
@SourceCodeAuthorClass(createdBy = "deepali.arvnd@algorhythm.co.in", updatedBy = "", versionNumber = "1", comments = "Service for Roles Transaction table", complexity = Complexity.MEDIUM)
...
public class RolesServiceImpl extends RolesService {
    ...
    public HttpEntity<ResponseBean> findAll() throws SpartanPersistenceException, Exception {
        ...
        java.util.List<loadcheck.app.shared.aaaboundedcontext.authorization.Roles> lstroles = rolesrepo.findAll();
    ...
    public HttpEntity<ResponseBean> findById(@RequestBody FindByBean findByBean) throws SpartanPersistenceException, Exception {
        ...
        org.springframework.http.HttpStatus httpStatus = org.springframework.http.HttpStatus.OK;
        try {
            loadcheck.app.shared.aaaboundedcontext.authorization.Roles lstroles = rolesrepo.findById((java.lang.String) findByBean.getFindKey());
            responseBean.add("success", true);
            responseBean.add("message", "Successfully retrived ");
            responseBean.add("data", lstroles);
        } catch (org.springframework.transaction.TransactionException e) {
