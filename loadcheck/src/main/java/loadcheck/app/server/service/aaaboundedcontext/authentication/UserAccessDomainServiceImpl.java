...
@RestController
@SourceCodeAuthorClass(createdBy = "deepali.arvnd@algorhythm.co.in", updatedBy = "", versionNumber = "1", comments = "Service for UserAccessDomain Master table Entity", complexity = Complexity.LOW)
...
public class UserAccessDomainServiceImpl extends UserAccessDomainService {
    ...
    public HttpEntity<ResponseBean> findAll() throws SpartanPersistenceException, Exception {
        ...
        java.util.List<loadcheck.app.shared.aaaboundedcontext.authentication.UserAccessDomain> lstuseraccessdomain = userAccessDomainrepo.findAll();
    ...
    public HttpEntity<ResponseBean> findById(@RequestBody FindByBean findByBean) throws SpartanPersistenceException, Exception {
        ...
        org.springframework.http.HttpStatus httpStatus = org.springframework.http.HttpStatus.OK;
        try {
            loadcheck.app.shared.aaaboundedcontext.authentication.UserAccessDomain lstuseraccessdomain = userAccessDomainrepo.findById((java.lang.String) findByBean.getFindKey());
            responseBean.add("success", true);
            responseBean.add("message", "Successfully retrived ");
            responseBean.add("data", lstuseraccessdomain);
        } catch (org.springframework.transaction.TransactionException e) {
