package loadcheck.app.server.service.appinsight.health.aspect;
...
public class ServicehealthAspect extends ServiceAspect {
    ...
    @Pointcut("execution(* loadcheck.app.server.service.appinsight.health..save*(..))")
    protected void saveOperation() {
    }

    @Pointcut("execution(* loadcheck.app.server.service.appinsight.health..update*(..))")
    protected void updateOperation() {
    }

    @Pointcut("execution(* loadcheck.app.server.service.appinsight.health..delete*(..))")
    protected void deleteOperation() {
    }

    @Pointcut("execution(* loadcheck.app.server.service.appinsight.health..find*(..))")
    protected void findOperation() {
    }

    @Pointcut("execution(* loadcheck.app.server.service.appinsight.health..get*(..)) && !within(com.spartan.shield.sessionService.SessionDataMgtService+)")
    protected void getOperation() {
    }

    @Pointcut("execution(* loadcheck.app.server.service.appinsight.health..*(..)) && !within(com.spartan.shield.sessionService.SessionDataMgtService+)")
