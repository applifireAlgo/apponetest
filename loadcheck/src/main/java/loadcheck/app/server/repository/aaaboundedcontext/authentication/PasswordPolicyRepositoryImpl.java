...
import loadcheck.app.shared.aaaboundedcontext.authentication.PasswordPolicy;
...
@Repository
@SourceCodeAuthorClass(createdBy = "deepali.arvnd@algorhythm.co.in", updatedBy = "", versionNumber = "1", comments = "Repository for PasswordPolicy Master table Entity", complexity = Complexity.LOW)
public class PasswordPolicyRepositoryImpl extends SearchInterfaceImpl implements PasswordPolicyRepository<PasswordPolicy> {
    ...
    public List<PasswordPolicy> save(List<PasswordPolicy> entity) throws SpartanPersistenceException, SpartanConstraintViolationException {
        try {
            ...
            for (int i = 0; i < entity.size(); i++) {
                loadcheck.app.shared.aaaboundedcontext.authentication.PasswordPolicy obj = entity.get(i);
    ...
    public void delete(String id) throws SpartanPersistenceException {
        try {
            javax.persistence.EntityManager emanager = emfResource.getResource();
            loadcheck.app.shared.aaaboundedcontext.authentication.PasswordPolicy s = emanager.find(loadcheck.app.shared.aaaboundedcontext.authentication.PasswordPolicy.class, id);
            emanager.remove(s);
        } catch (javax.persistence.PersistenceException e) {
    ...
    public PasswordPolicy findById(String policyId) throws Exception, SpartanPersistenceException {
        try {
            ...
            loadcheck.app.shared.aaaboundedcontext.authentication.PasswordPolicy listOfPasswordPolicy = (loadcheck.app.shared.aaaboundedcontext.authentication.PasswordPolicy) query.getSingleResult();
