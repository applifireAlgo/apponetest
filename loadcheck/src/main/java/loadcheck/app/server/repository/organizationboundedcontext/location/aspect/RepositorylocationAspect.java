package loadcheck.app.server.repository.organizationboundedcontext.location.aspect;
...
public class RepositorylocationAspect extends RepositoryAspect {
    ...
    @Pointcut("execution(* loadcheck.app.server.repository.organizationboundedcontext.location..save*(..))")
    protected void saveOperation() {
    }

    @Pointcut("execution(* loadcheck.app.server.repository.organizationboundedcontext.location..update*(..))")
    protected void updateOperation() {
    }

    @Pointcut("execution(* loadcheck.app.server.repository.organizationboundedcontext.location..delete*(..))")
    protected void deleteOperation() {
    }

    @Pointcut("execution(* loadcheck.app.server.repository.organizationboundedcontext.location..find*(..))")
    protected void findOperation() {
    }

    @Pointcut("execution(* loadcheck.app.server.repository.organizationboundedcontext.location..get*(..))")
    protected void getOperation() {
    }

    @Pointcut("execution(* loadcheck.app.server.repository.organizationboundedcontext.location..*(..))")
