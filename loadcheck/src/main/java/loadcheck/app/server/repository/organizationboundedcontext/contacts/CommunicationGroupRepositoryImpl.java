...
@Repository
@SourceCodeAuthorClass(createdBy = "deepali.arvnd@algorhythm.co.in", updatedBy = "", versionNumber = "1", comments = "Repository for CommunicationGroup Master table Entity", complexity = Complexity.LOW)
public class CommunicationGroupRepositoryImpl extends SearchInterfaceImpl implements CommunicationGroupRepository<CommunicationGroup> {
    ...
    public List<CommunicationGroup> findAll() throws SpartanPersistenceException {
        try {
            ...
            java.util.List<loadcheck.app.shared.organizationboundedcontext.contacts.CommunicationGroup> query = emanager.createQuery("select u from CommunicationGroup u where u.systemInfo.activeStatus=1").getResultList();
            return query;
    ...
    public List<CommunicationGroup> save(List<CommunicationGroup> entity) throws SpartanPersistenceException, SpartanConstraintViolationException {
        try {
            ...
            for (int i = 0; i < entity.size(); i++) {
                loadcheck.app.shared.organizationboundedcontext.contacts.CommunicationGroup obj = entity.get(i);
    ...
    public void delete(String id) throws SpartanPersistenceException {
        try {
            javax.persistence.EntityManager emanager = emfResource.getResource();
            loadcheck.app.shared.organizationboundedcontext.contacts.CommunicationGroup s = emanager.find(loadcheck.app.shared.organizationboundedcontext.contacts.CommunicationGroup.class, id);
            emanager.remove(s);
        } catch (javax.persistence.PersistenceException e) {
    ...
    public CommunicationGroup findById(String commGroupId) throws Exception, SpartanPersistenceException {
        try {
            ...
            loadcheck.app.shared.organizationboundedcontext.contacts.CommunicationGroup listOfCommunicationGroup = (loadcheck.app.shared.organizationboundedcontext.contacts.CommunicationGroup) query.getSingleResult();
