package loadcheck.app.server.repository.organizationboundedcontext.contacts.aspect;
import loadcheck.app.server.repository.aspect.RepositoryAspect;
...
public class RepositorycontactsAspect extends RepositoryAspect {
    ...
    @Pointcut("execution(* loadcheck.app.server.repository.organizationboundedcontext.contacts..save*(..))")
    protected void saveOperation() {
    }

    @Pointcut("execution(* loadcheck.app.server.repository.organizationboundedcontext.contacts..update*(..))")
    protected void updateOperation() {
    }

    @Pointcut("execution(* loadcheck.app.server.repository.organizationboundedcontext.contacts..delete*(..))")
    protected void deleteOperation() {
    }

    @Pointcut("execution(* loadcheck.app.server.repository.organizationboundedcontext.contacts..find*(..))")
    protected void findOperation() {
    }

    @Pointcut("execution(* loadcheck.app.server.repository.organizationboundedcontext.contacts..get*(..))")
    protected void getOperation() {
    }

    @Pointcut("execution(* loadcheck.app.server.repository.organizationboundedcontext.contacts..*(..))")
