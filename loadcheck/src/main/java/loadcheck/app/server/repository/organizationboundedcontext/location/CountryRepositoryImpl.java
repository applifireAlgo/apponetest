...
@Repository
@SourceCodeAuthorClass(createdBy = "deepali.arvnd@algorhythm.co.in", updatedBy = "", versionNumber = "1", comments = "Repository for Country Master table Entity", complexity = Complexity.LOW)
public class CountryRepositoryImpl extends SearchInterfaceImpl implements CountryRepository<Country> {
    ...
    public List<Country> findAll() throws SpartanPersistenceException {
        try {
            ...
            java.util.List<loadcheck.app.shared.organizationboundedcontext.location.Country> query = emanager.createQuery("select u from Country u where u.systemInfo.activeStatus=1").getResultList();
            return query;
    ...
    public List<Country> save(List<Country> entity) throws SpartanPersistenceException, SpartanConstraintViolationException {
        try {
            ...
            for (int i = 0; i < entity.size(); i++) {
                loadcheck.app.shared.organizationboundedcontext.location.Country obj = entity.get(i);
    ...
    public void delete(String id) throws SpartanPersistenceException {
        try {
            javax.persistence.EntityManager emanager = emfResource.getResource();
            loadcheck.app.shared.organizationboundedcontext.location.Country s = emanager.find(loadcheck.app.shared.organizationboundedcontext.location.Country.class, id);
            emanager.remove(s);
        } catch (javax.persistence.PersistenceException e) {
    ...
    public Country findById(String countryId) throws Exception, SpartanPersistenceException {
        try {
            ...
            loadcheck.app.shared.organizationboundedcontext.location.Country listOfCountry = (loadcheck.app.shared.organizationboundedcontext.location.Country) query.getSingleResult();
