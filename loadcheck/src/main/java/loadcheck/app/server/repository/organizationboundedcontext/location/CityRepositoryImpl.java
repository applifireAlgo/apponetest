...
public class CityRepositoryImpl extends SearchInterfaceImpl implements CityRepository<City> {
    ...
    public List<City> findAll() throws SpartanPersistenceException {
        try {
            ...
            java.util.List<loadcheck.app.shared.organizationboundedcontext.location.City> query = emanager.createQuery("select u from City u where u.systemInfo.activeStatus=1").getResultList();
            return query;
    ...
    public List<City> save(List<City> entity) throws SpartanPersistenceException, SpartanConstraintViolationException {
        try {
            ...
            for (int i = 0; i < entity.size(); i++) {
                loadcheck.app.shared.organizationboundedcontext.location.City obj = entity.get(i);
    ...
    public void delete(String id) throws SpartanPersistenceException {
        try {
            javax.persistence.EntityManager emanager = emfResource.getResource();
            loadcheck.app.shared.organizationboundedcontext.location.City s = emanager.find(loadcheck.app.shared.organizationboundedcontext.location.City.class, id);
            emanager.remove(s);
        } catch (javax.persistence.PersistenceException e) {
    ...
    public List<City> findByCountryId(String countryId) throws Exception, SpartanPersistenceException {
        try {
            ...
            java.util.List<loadcheck.app.shared.organizationboundedcontext.location.City> listOfCity = query.getResultList();
            return listOfCity;
        } catch (javax.persistence.PersistenceException e) {
    ...
    public City findById(String cityId) throws Exception, SpartanPersistenceException {
        try {
            ...
            loadcheck.app.shared.organizationboundedcontext.location.City listOfCity = (loadcheck.app.shared.organizationboundedcontext.location.City) query.getSingleResult();
            return listOfCity;
        } catch (javax.persistence.PersistenceException e) {
            throw new com.athena.framework.server.exception.repository.SpartanPersistenceException("Error in executing query", e);
        }
