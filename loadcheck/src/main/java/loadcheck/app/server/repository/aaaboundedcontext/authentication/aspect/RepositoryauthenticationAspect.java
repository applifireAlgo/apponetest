package loadcheck.app.server.repository.aaaboundedcontext.authentication.aspect;
...
public class RepositoryauthenticationAspect extends RepositoryAspect {
    ...
    @Pointcut("execution(* loadcheck.app.server.repository.aaaboundedcontext.authentication..save*(..))")
    protected void saveOperation() {
    }

    @Pointcut("execution(* loadcheck.app.server.repository.aaaboundedcontext.authentication..update*(..))")
    protected void updateOperation() {
    }

    @Pointcut("execution(* loadcheck.app.server.repository.aaaboundedcontext.authentication..delete*(..))")
    protected void deleteOperation() {
    }

    @Pointcut("execution(* loadcheck.app.server.repository.aaaboundedcontext.authentication..find*(..))")
    protected void findOperation() {
    }

    @Pointcut("execution(* loadcheck.app.server.repository.aaaboundedcontext.authentication..get*(..))")
    protected void getOperation() {
    }

    @Pointcut("execution(* loadcheck.app.server.repository.aaaboundedcontext.authentication..*(..))")
