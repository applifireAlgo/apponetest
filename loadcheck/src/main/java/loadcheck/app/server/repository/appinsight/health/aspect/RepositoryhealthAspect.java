package loadcheck.app.server.repository.appinsight.health.aspect;
...
public class RepositoryhealthAspect extends RepositoryAspect {
    ...
    @Pointcut("execution(* loadcheck.app.server.repository.appinsight.health..save*(..))")
    protected void saveOperation() {
    }

    @Pointcut("execution(* loadcheck.app.server.repository.appinsight.health..update*(..))")
    protected void updateOperation() {
    }

    @Pointcut("execution(* loadcheck.app.server.repository.appinsight.health..delete*(..))")
    protected void deleteOperation() {
    }

    @Pointcut("execution(* loadcheck.app.server.repository.appinsight.health..find*(..))")
    protected void findOperation() {
    }

    @Pointcut("execution(* loadcheck.app.server.repository.appinsight.health..get*(..))")
    protected void getOperation() {
    }

    @Pointcut("execution(* loadcheck.app.server.repository.appinsight.health..*(..))")
