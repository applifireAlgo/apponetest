package loadcheck.app.server.businessservice.aaaboundedcontext.authentication.aspect;
...
public class BusinessServiceauthenticationAspect extends BusinessAspect {
    ...
    @Pointcut("execution(* loadcheck.app.server.businessservice.aaaboundedcontext.authentication..*(..))")
