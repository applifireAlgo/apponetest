package loadcheck.app.server.businessservice.organizationboundedcontext.contacts.aspect;
import loadcheck.app.server.businessservice.aspect.BusinessAspect;
...
public class BusinessServicecontactsAspect extends BusinessAspect {
    ...
    @Pointcut("execution(* loadcheck.app.server.businessservice.organizationboundedcontext.contacts..*(..))")
