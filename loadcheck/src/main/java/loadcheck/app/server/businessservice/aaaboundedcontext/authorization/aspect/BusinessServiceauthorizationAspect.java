package loadcheck.app.server.businessservice.aaaboundedcontext.authorization.aspect;
...
public class BusinessServiceauthorizationAspect extends BusinessAspect {
    ...
    @Pointcut("execution(* loadcheck.app.server.businessservice.aaaboundedcontext.authorization..*(..))")
