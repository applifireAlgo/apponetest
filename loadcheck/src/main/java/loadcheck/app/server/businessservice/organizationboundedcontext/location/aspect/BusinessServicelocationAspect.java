package loadcheck.app.server.businessservice.organizationboundedcontext.location.aspect;
...
public class BusinessServicelocationAspect extends BusinessAspect {
    ...
    @Pointcut("execution(* loadcheck.app.server.businessservice.organizationboundedcontext.location..*(..))")
