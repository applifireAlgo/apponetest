package loadcheck.app.shared.organizationboundedcontext.contacts;
...
import loadcheck.app.shared.EntityAudit;
import loadcheck.app.shared.SystemInfo;
...
@SourceCodeAuthorClass(createdBy = "deepali.arvnd@algorhythm.co.in", updatedBy = "", versionNumber = "1", comments = "CoreContacts", complexity = Complexity.LOW)
...
public class CoreContacts implements Serializable, CommonEntityInterface, CoreContactsInterface, Comparator<CoreContacts> {
    ...
    public CoreContacts addCommunicationData(CommunicationData _communicationData) {
        if (this.communicationData == null) {
            this.communicationData = new java.util.ArrayList<loadcheck.app.shared.organizationboundedcontext.contacts.CommunicationData>();
        }
    ...
    public CoreContacts addAddress(Address _address) {
        if (this.address == null) {
            this.address = new java.util.ArrayList<loadcheck.app.shared.organizationboundedcontext.location.Address>();
        }
        if (_address != null) {
    ...
    public boolean equals(Object obj) {
        try {
            loadcheck.app.shared.organizationboundedcontext.contacts.CoreContacts other = (loadcheck.app.shared.organizationboundedcontext.contacts.CoreContacts) obj;
            if (contactId == null) {
                return false;
