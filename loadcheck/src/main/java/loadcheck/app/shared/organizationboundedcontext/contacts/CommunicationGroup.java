...
public class CommunicationGroup implements Serializable, CommonEntityInterface, Comparator<CommunicationGroup> {
    ...
    public boolean equals(Object obj) {
        try {
            loadcheck.app.shared.organizationboundedcontext.contacts.CommunicationGroup other = (loadcheck.app.shared.organizationboundedcontext.contacts.CommunicationGroup) obj;
            if (commGroupId == null) {
                return false;
