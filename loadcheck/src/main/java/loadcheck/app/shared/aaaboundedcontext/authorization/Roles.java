package loadcheck.app.shared.aaaboundedcontext.authorization;
...
@SourceCodeAuthorClass(createdBy = "deepali.arvnd@algorhythm.co.in", updatedBy = "", versionNumber = "1", comments = "Roles", complexity = Complexity.LOW)
...
public class Roles implements Serializable, CommonEntityInterface, Comparator<Roles> {
    ...
    public Roles addRoleMenuBridge(RoleMenuBridge _roleMenuBridge) {
        if (this.roleMenuBridge == null) {
            this.roleMenuBridge = new java.util.ArrayList<loadcheck.app.shared.aaaboundedcontext.authorization.RoleMenuBridge>();
        }
    ...
    public boolean equals(Object obj) {
        try {
            loadcheck.app.shared.aaaboundedcontext.authorization.Roles other = (loadcheck.app.shared.aaaboundedcontext.authorization.Roles) obj;
            if (roleId == null) {
                return false;
