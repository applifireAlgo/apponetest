...
@SourceCodeAuthorClass(createdBy = "deepali.arvnd@algorhythm.co.in", updatedBy = "", versionNumber = "1", comments = "Question", complexity = Complexity.LOW)
...
public class Question implements Serializable, CommonEntityInterface, Comparator<Question> {
    ...
    public boolean equals(Object obj) {
        try {
            loadcheck.app.shared.aaaboundedcontext.authentication.Question other = (loadcheck.app.shared.aaaboundedcontext.authentication.Question) obj;
            if (questionId == null) {
                return false;
