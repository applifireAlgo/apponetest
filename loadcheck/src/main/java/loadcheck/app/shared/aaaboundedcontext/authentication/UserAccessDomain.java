...
public class UserAccessDomain implements Serializable, CommonEntityInterface, Comparator<UserAccessDomain> {
    ...
    public boolean equals(Object obj) {
        try {
            loadcheck.app.shared.aaaboundedcontext.authentication.UserAccessDomain other = (loadcheck.app.shared.aaaboundedcontext.authentication.UserAccessDomain) obj;
            if (userAccessDomainId == null) {
                return false;
