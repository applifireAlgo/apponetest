 ...
 * 
 */
Ext.define('Loadcheck.view.logalarm.mainscreen.AddLogAlarm', {
	extend : 'Ext.form.Panel',
	xtype : 'addLogAlarm',
	requires : [ 'Loadcheck.view.logalarm.mainscreen.AddLogAlarmController',
			'Loadcheck.view.logalarm.mainscreen.AppAlarmGridPanel',
			'Loadcheck.view.logalarm.mainscreen.AppAlarmPanel',
