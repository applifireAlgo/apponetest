 ...
 * 
 */
Ext.define('Loadcheck.view.logalarm.LogAlarmMainView', {
	extend : 'Ext.form.Panel',
	xtype : 'logAlarmMainView',
	requires : [ 'Loadcheck.view.logalarm.LogAlarmMainViewController',
			'Loadcheck.view.logalarm.tree.LogAlarmTreePanel',
			'Loadcheck.view.logalarm.mainscreen.LogAlarmMainViewTabPanel',
