Ext.define('Loadcheck.view.fw.frameworkController.RegistrationGridViewController', {
     extend: 'Loadcheck.view.fw.frameworkController.FrameworkViewController',
     ...
     onConsoleClick: function() {
          var window = Ext.create('Loadcheck.view.console.ConsoleWindow');
