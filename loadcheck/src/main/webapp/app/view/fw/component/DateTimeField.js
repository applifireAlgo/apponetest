 ...
 */
Ext.define('Loadcheck.view.fw.component.DateTimeField', {
    extend: 'Ext.form.field.Date',
    alias: 'widget.customdatetimefield',
    xtype : 'customdatetimefield',
    requires: ['Loadcheck.view.fw.component.DateTimePicker'
               ],
    ...
    createPicker: function() {
        ...
        return new Loadcheck.view.fw.component.DateTimePicker(o);
    },
