...
Ext
		.define(
				'Loadcheck.view.logger.LogConfigurationTabPanel',
				{
					...
					requires : [
							'Loadcheck.view.logger.tabs.details.DetailsTab',
							'Loadcheck.view.logger.tabs.fileconnector.FileConnectorTab',
							'Loadcheck.view.logger.tabs.dbconnector.DBConnectorTab',
							'Loadcheck.view.logger.tabs.syslogsocketconnector.SyslogSocketConnectorTab',
							'Loadcheck.view.logger.tabs.tcpsocketconnector.TCPSocketConnectorTab',
							'Loadcheck.view.logger.LogConfigurationTabPanelController',
