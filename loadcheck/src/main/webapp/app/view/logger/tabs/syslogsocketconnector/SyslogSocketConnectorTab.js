 ...
 * 
 */
Ext.define('Loadcheck.view.logger.tabs.syslogsocketconnector.SyslogSocketConnectorTab', {
	...
	requires : ['Loadcheck.view.logger.tabs.syslogsocketconnector.SyslogSocketConnectorTabController'],
