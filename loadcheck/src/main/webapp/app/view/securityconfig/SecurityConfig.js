 ...
 * 
 */
Ext.define('Loadcheck.view.securityconfig.SecurityConfig', {
	extend : 'Ext.form.Panel',
	xtype : 'securityConfig',
	requires : [ 'Loadcheck.view.securityconfig.SecurityConfigController',
			'Loadcheck.view.securityconfig.SecurityQuestion', 'Ext.form.FieldSet',
