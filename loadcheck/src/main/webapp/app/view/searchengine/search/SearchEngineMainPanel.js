Ext.define('Loadcheck.view.searchengine.search.SearchEngineMainPanel', {
	extend : 'Ext.panel.Panel',
	xtype : 'solrsearchmainpanel',
	

	requires : ['Loadcheck.view.searchengine.search.NorthPanel', 'Loadcheck.view.searchengine.search.SearchResult','Loadcheck.view.searchengine.search.SearchEngineMainPanelController'],
