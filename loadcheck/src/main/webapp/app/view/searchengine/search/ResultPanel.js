Ext
		.define(
				'Loadcheck.view.searchengine.search.ResultPanel',
				{
					extend : 'Ext.panel.Panel',
					xtype : 'resultPanel',
					itemId : "resultsTab",
					plugins : 'responsive',
					requires : [ 'Loadcheck.view.searchengine.search.SearchEngineMainPanelController','Loadcheck.view.searchengine.search.PanelHeaderField' ,'Loadcheck.view.searchengine.search.ReportGridView','Loadcheck.view.searchengine.search.ReportChartView','Loadcheck.view.searchengine.search.documentView','Loadcheck.view.searchengine.search.DouMeanView','Loadcheck.view.googlemaps.map.MapPanel'],
