Ext.define('Loadcheck.view.mainleftmenutree.TopPanel.TopPanelController', {
	...
	onCloudClick : function()
	{
		var component = Ext.create(
				"Loadcheck.view.clouddrive.CloudDrive", {
					closable : true,
					title : "Cloud Drive"
					//refId : "-1"
				});
	...
	{
		var component = Ext.create(
				"Loadcheck.view.usermanagement.enduser.UserProfile", {
					closable : true,
					title : "My Profile"
				});
	...
	{
		var component = Ext.create(
				"Loadcheck.view.usermanagement.enduser.ChangePwd", {
					closable : true,
