 ...
 * 
 */
Ext.define("Loadcheck.view.scheduleconfiguration.tree.ScheduleConfigTree", {
	extend : 'Ext.panel.Panel',
	requires : [ 'Loadcheck.view.scheduleconfiguration.tree.ScheduleConfigTreeController' ],
