Ext.define('Loadcheck.view.usermanagement.enduser.UserProfile', {
	extend : 'Ext.form.Panel',
	xtype : 'userProfileView',
	requires : [ 'Loadcheck.view.usermanagement.enduser.UserProfileController', 'Loadcheck.view.usermanagement.admin.AddUserDetailsViewModel', 'Loadcheck.model.AddUserDataModel' ],
