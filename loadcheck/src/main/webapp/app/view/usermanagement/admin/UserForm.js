Ext.define('Loadcheck.view.usermanagement.admin.UserForm', {
	extend : 'Ext.form.Panel',
	xtype : 'userForm',
	itemId : 'userForm',
	requires : [ 'Loadcheck.view.usermanagement.admin.AddUserDetailsViewModel', 'Loadcheck.model.AddUserDataModel' ],
