Ext.define('Loadcheck.view.usermanagement.admin.AdminUserManagement', {
	extend : 'Ext.tab.Panel',
	requires : ['Loadcheck.view.usermanagement.admin.UserPasswordReset',
	            'Loadcheck.view.usermanagement.admin.AddUserDetails',
	            'Loadcheck.view.usermanagement.admin.ViewUser'],
