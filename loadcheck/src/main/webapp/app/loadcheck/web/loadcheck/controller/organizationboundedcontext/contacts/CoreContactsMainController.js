Ext.define('Loadcheck.loadcheck.web.loadcheck.controller.organizationboundedcontext.contacts.CoreContactsMainController', {
     extend: 'Loadcheck.view.fw.frameworkController.AggregateViewController',
