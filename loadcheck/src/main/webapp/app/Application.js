 ...
 */
Ext.define('Loadcheck.Application', {
	...
	requires : [ "Ext.ux.BoxReorderer", "Ext.ux.CellDragDrop",
			...
			"Ext.ProgressBarWidget", "Ext.ZIndexManager","Loadcheck.view.databrowsercalendar.DBCalendar" ],
	...
	stores : [ 'Loadcheck.store.QueryCriteriaWidgetsStore' ],
	...
	try {
		...
		if (responseData.response) {
			if (responseData.response.exceptionId == 4005 && !sessionTimeOutFlag) {
				...
				var loginWindow = Ext.create('Loadcheck.view.login.SessionLogin').center();
