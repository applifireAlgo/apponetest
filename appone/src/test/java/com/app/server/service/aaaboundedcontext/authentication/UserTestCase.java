...
<<<<<<< HEAD
        ...
        useraccessdomain.setDomainHelp("5elKBpBzfrXHdMPuBwkSLA4vuS7MhsCaAR2lfFFT4yzEt3MOq2");
        ...
        useraccesslevel.setLevelName("cvBn4krnFF0Pc2SEQCLOk1dUyhRhhxsPEIjHjkDwKqZRZ5fKtA");
        useraccesslevel.setLevelHelp("2UoC6uCiQQbrRY6X9WQFiyPyzrGybfU3hDkdr3e7EdkOhCHUkL");
        useraccesslevel.setLevelDescription("9gSnnMk68iWENexMmiULpp0katqLYmQy6pL6017gj3cel9hvIL");
        useraccesslevel.setUserAccessLevel(valueGenerator.getRandomInteger(99999, 0));
        useraccesslevel.setLevelIcon("FXX5jobiunjrMY48faQd2oNPfsv74XgE8ZfT2Bx9RUFFasmrig");
        ...
        User user = new User();
        user.setSessionTimeout(1997);
        user.setChangePasswordNextLogin(1);
        user.setIsDeleted(1);
        user.setAllowMultipleLogin(1);
        user.setGenTempOneTimePassword(1);
        user.setMultiFactorAuthEnabled(1);
        user.setPasswordAlgo("u068CbN9JkuDXh5aJR8CDksSPlkwx21oLZDj1YqaGrSMS8dWI9");
        user.setUserAccessDomainId((java.lang.String) UserAccessDomainTest._getPrimarykey()); /* ******Adding refrenced table data */
        user.setUserAccessLevelId((java.lang.String) UserAccessLevelTest._getPrimarykey()); /* ******Adding refrenced table data */
        user.setPasswordExpiryDate(new java.sql.Timestamp(1459578731415l));
        user.setUserAccessCode(34259);
        user.setLastPasswordChangeDate(new java.sql.Timestamp(1459578731415l));
        user.setIsLocked(1);
        java.util.List<PassRecovery> listOfPassRecovery = new java.util.ArrayList<PassRecovery>();
        PassRecovery passrecovery = new PassRecovery();
        Question question = new Question();
        question.setQuestionDetails("RinpmSunbH");
        question.setQuestion("BPKPLWD6sPeaGxMfTBCFABPcaFTj4w3JmJoppy90kgSRwb8abU");
        question.setLevelid(4);
        question.setQuestionIcon("IONYBV8N48TswwyzhXrE3BC2ubtqmuJpeN8HIDzxFlKTxwH1F9");
        ...
        passrecovery.setAnswer("ZV4sqOurBNj7ni7M1GozzawF76BRDnapnQWH3aT44He85VR6Ha");
        listOfPassRecovery.add(passrecovery);
        user.addAllPassRecovery(listOfPassRecovery);
        UserData userdata = new UserData();
        userdata.setOneTimePasswordGenDate(new java.sql.Timestamp(1459578731873l));
        userdata.setOneTimePassword("pmyqWDJFDCBxYt49FDF0XQnheuMwynBR");
        userdata.setOneTimePasswordGenDate(new java.sql.Timestamp(1459578731901l));
        userdata.setOneTimePassword("AiFy4bKRvgQJYLp6QnJ7nI08vWp2InE1");
        userdata.setUser(user);
        userdata.setPassword("6jFAP1HdvI6wEKbAaq1xJ54XSZ1NZZof4ttAPSj4NN8O89bYig");
        userdata.setOneTimePasswordExpiry(9);
        userdata.setLast5Passwords("A4HYtVeRNjTW4ArmNQgCL8nCuDo3qbYyhuhIVuMceJJUnzmLIA");
    ...
    private List<EntityTestCriteria> addingListOfFieldForNegativeTesting() {
        ...
        entityContraints.add(new EntityTestCriteria(MIN_MAX, 1, "userAccessCode", 65800));
