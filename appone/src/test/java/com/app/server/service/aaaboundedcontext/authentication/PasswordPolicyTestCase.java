...
<<<<<<< HEAD
        ...
        passwordpolicy.setPolicyDescription("mWS6WVLkFXIogi7wr5nN9GLFiXH8XXakeG9J3IxkGBH3Hx9hcO");
        passwordpolicy.setMinPwdLength(7);
        passwordpolicy.setMinSmallLetters(6);
        passwordpolicy.setAllowedSpecialLetters("qRXqejvx60dkfv48rXY5ndgUmSLxpqXRP3MInHb85gsc7CYKlU");
    ...
    public void test2Update() {
        try {
            ...
            passwordpolicy.setPolicyName("WJOpqanOnJ8TgG2JiOgPWSm4uQ6F3SGDhXDTOLmcJmAcH89qrX");
            passwordpolicy.setMinCapitalLetters(6);
            passwordpolicy.setMinNumericValues(4);
            passwordpolicy.setMaxPwdLength(32);
            passwordpolicy.setPolicyDescription("CNehhtPZlyIJWT2boJvtTJ3qYAuzRmWuwSIiMMY5B2MxtyfJ5P");
            passwordpolicy.setMinPwdLength(1);
            passwordpolicy.setMinSmallLetters(1);
            passwordpolicy.setAllowedSpecialLetters("ahc06c5RxzYJ0T1GVf70IfrN0mp5BKr1Hgh1tfHCtYPgNNvL5E");
            passwordpolicy.setMinSpecialLetters(6);
    ...
    private List<EntityTestCriteria> addingListOfFieldForNegativeTesting() {
        ...
        entityContraints.add(new EntityTestCriteria(MIN_MAX, 2, "policyName", ""));
        entityContraints.add(new EntityTestCriteria(MIN_MAX, 3, "policyDescription", ""));
        entityContraints.add(new EntityTestCriteria(MIN_MAX, 4, "maxPwdLength", 41));
