...
Ext.define('Appone.view.reportui.datachart.chart.RatingField', {
	...
	onRender: function(ct, position) {
		Appone.view.reportui.datachart.chart.RatingField.superclass.onRender.call(this, ct, position);
	 ...
	 */
	initEvents: function() {
		Appone.view.reportui.datachart.chart.RatingField.superclass.initEvents.call(this);
